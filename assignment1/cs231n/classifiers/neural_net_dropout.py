...
class TwoLayerNetWithDropOut(object):
  """
  ...
  def loss(self, X, y=None, reg=0.0, do_dropout = True, dropout_percent = 0.2):
    """
    ...
    if do_dropout:
        h1 *= np.random.binomial([np.ones((len(X),W1.shape[1]))],1-dropout_percent)[0] * (1.0/(1-dropout_percent)) 
  ...
  def train(self, X, y, X_val, y_val,
            ...
            batch_size=200, do_dropout = True, dropout_percent = 0.2, verbose=False):
    """
