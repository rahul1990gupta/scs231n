...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        stride = 1
        pad = (filter_size - 1)/2
        H1 = 1 + int ((input_dim[1] + 2 * pad - filter_size)/stride)
        W1 = 1 + int ((input_dim[2] + 2 * pad - filter_size)/stride)  
        
        self.params["W1"] = np.random.normal(0, weight_scale, size = (num_filters, input_dim[0], filter_size, filter_size))
        
        self.params["W2"] = np.random.normal(0, weight_scale, size = (int( num_filters * H1 * W1 * 0.25 ), hidden_dim) )
    ...
    def loss(self, X, y=None):
        ...
        ############################################################################
        loss, dout6 = softmax_loss(out6, y)
        dout5, grads["W3"] , grads["b3"]= affine_backward(dout6, cache6)
        ...
        dout, grads["W1"] , grads["b1"]  = conv_backward_fast(dout1, cache1)
